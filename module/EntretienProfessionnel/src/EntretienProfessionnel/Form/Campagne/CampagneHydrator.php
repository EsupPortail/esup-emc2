...
class  CampagneHydrator implements HydratorInterface {
    ...
    public function extract($object)
    {
        $data = [
            ...
            'date_circulaire' => $object->getDateCirculaire()?$object->getDateCirculaire()->format('d/m/Y'):null,
    ...
    public function hydrate(array $data, $object)
    {
        ...
        $date_circulaire   = (isset($data['date_circulaire']))?   DateTime::createFromFormat('d/m/Y H:i:s',$data['date_circulaire']. ' 08:00:00'):null;
