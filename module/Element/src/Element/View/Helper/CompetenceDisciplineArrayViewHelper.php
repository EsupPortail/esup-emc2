...
class CompetenceDisciplineArrayViewHelper extends AbstractHelper
{
    /**
    ...
    public function __invoke(array $competences, CompetenceType $type, ?HasApplicationCollectionInterface $objet = null, string $mode = "affichage", array $options = []): string|Partial
    {
        ...
        return $view->partial('competence-discipline-array', ['competences' => $competences, 'type' => $type, 'object' => $objet, 'mode' => $mode, 'options' => $options]);
    }
}