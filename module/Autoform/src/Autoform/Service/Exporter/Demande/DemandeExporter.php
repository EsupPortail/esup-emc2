...
namespace Autoform\Service\Exporter\Demande;

use UnicaenApp\Exporter\Pdf as PdfExporter;
use Zend\View\Renderer\PhpRenderer;
use Zend\View\Resolver\TemplatePathStack;

class DemandeExporter extends PdfExporter
{
    private $vars;
...
//        $this->setFooterScript('empty.phtml');
        $this->addBodyScript('demande.phtml', false, $this->vars);
        $this->addBodyScript('formulaire.phtml', true, $this->vars);
