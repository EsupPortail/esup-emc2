...
namespace Autoform\Service\Exporter\Validation;

use UnicaenApp\Exporter\Pdf as PdfExporter;
use Zend\View\Renderer\PhpRenderer;
use Zend\View\Resolver\TemplatePathStack;

class ValidationExporter extends PdfExporter
{
    private $vars;
...
//        $this->setFooterScript('empty.phtml');
        $this->addBodyScript('validation.phtml', false, $this->vars);
        $this->addBodyScript('resultat.phtml', false, $this->vars);
        $this->addBodyScript('signature.phtml', false, $this->vars);
