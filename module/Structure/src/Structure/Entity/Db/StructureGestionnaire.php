...
class StructureGestionnaire implements HasPeriodeInterface, IsSynchronisableInterface, HistoriqueAwareInterface, ResourceInterface
{
    ...
    {
        if ($this->getAgent() === null) { throw new RuntimeException("StructureGestionnaire::generateId() : Agent manquant");}
        if ($this->getStructure() === null) { throw new RuntimeException("StructureGestionnaire::generateId() : Structure manquante");}
        if ($this->getDateDebut() === null) { throw new RuntimeException("StructureGestionnaire::generateId() : Date de début manquant");}
