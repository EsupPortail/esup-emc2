...
class MissionspecifiquePrivileges extends Privileges
{
    ...
    const MISSIONSPECIFIQUE_AFFECTATION_HISTORISER  = 'missionspecifique-missionspecifique_affectation_historiser';
    const MISSIONSPECIFIQUE_AFFECTATION_DETRUIRE    = 'missionspecifique-missionspecifique_affectation_detruire';
}