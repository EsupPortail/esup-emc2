...
class DemandeexternePrivileges extends Privileges
{
    const DEMANDEEXTERNE_INDEX = 'demandeexterne-demandeexterne_index';
    const DEMANDEEXTERNE_AFFICHER = 'demandeexterne-demandeexterne_afficher';
    const DEMANDEEXTERNE_AJOUTER = 'demandeexterne-demandeexterne_ajouter';
    const DEMANDEEXTERNE_MODIFIER = 'demandeexterne-demandeexterne_modifier';
