...
return [
    ...
    'columns'     => [
        ...
        'date_fixe'             => [
            ...
            'default'     => NULL,
            'position'    => 18,
            'commentaire' => 'Colonne ajoutée pour faire fonctionner la 5.3.0',
        ],
        'formulaire_cref_id'    => [
            'name'        => 'formulaire_cref_id',
            'type'        => 'int',
            'bdd-type'    => 'integer',
            'length'      => 0,
            'scale'       => NULL,
        ...
        'template_cref_id'      => [
            ...
            'default'     => NULL,
            'position'    => 17,
            'commentaire' => 'ajout pour faire fonctionner la 5.3',
        ],
        'template_crep_id'      => [
            'name'        => 'template_crep_id',
            'type'        => 'int',
            'bdd-type'    => 'integer',
            'length'      => 0,
            'scale'       => NULL,
