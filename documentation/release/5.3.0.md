...
alter table entretienprofessionnel_campagne add template_crep_id integer
        constraint epc_unicaen_renderer_template_id_fk references unicaen_renderer_template on delete set null;
alter table entretienprofessionnel_campagne add template_cref_id integer
        constraint epc_unicaen_renderer_template_id_fk_2 references unicaen_renderer_template on delete set null;
...
update entretienprofessionnel_campagne set template_crep_id = (select id from unicaen_autoform_formulaire where code='CREF - Compte rendu d''entretien de formation') where template_crep_id IS NULL ;
