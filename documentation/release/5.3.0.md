...
* Montée en version d'`unicaen/autoform` en 6.3.0
* Montée en version d'`unicaen/indicateur` en 6.5.3
* Montée en version d'`unicaen/observation` en 1.0.0
* Montée en version d'`unicaen/validation` en 6.1.7