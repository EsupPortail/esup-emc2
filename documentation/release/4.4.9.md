...
INSERT INTO unicaen_utilisateur_role (role_id, libelle, is_default, is_auto, description)
VALUES ('Observateur·trice (Entretien Professionnel)', 'Observateur·trice (Entretien Professionnel)', false, true, 'Rôle permettant de visualiser des entretiens professionnels pour lesquels on a été nommé·e observateur·trice');
