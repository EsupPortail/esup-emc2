...
Modification des tables associées aux métiers
```postgresql
...
update unicaen_parametre_parametre set valeur='16/10/2025' where code='RELEASE_DATE';
```
...
L'arrivée de nouveaux privilèges :
1. `chaine_afficher_historique` pour l'affichage de l'historique des chaînes hiérarchiques.