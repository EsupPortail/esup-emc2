...
alter table ficheposte_missionsadditionnelles add mission_id integer not null constraint ficheposte_missionsadditionnelles_missionprincipale_id_fk_2 references missionprincipale on delete cascade;
