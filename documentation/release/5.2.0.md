...
ALTER TABLE structure DROP CONSTRAINT structure_niv2_id_fk;
ALTER TABLE structure DROP CONSTRAINT structure_niv2_id_ow_fk;
...
drop table ficheposte_activitedescription_retiree;
