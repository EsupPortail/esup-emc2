...
VALUES ('rappel_campagne_autorite', 'Rappel avancement campagne EP [Autorité hiérarchique]', 'Rappel avancement campagne EP [Autorité hiérarchique]', 'campagne', 'P4W');
INSERT INTO unicaen_evenement_type (code, libelle, description, parametres, recursion)
VALUES ('rappel_campagne_superieur', 'Rappel avancement campagne EP [Supérieur·e hiérarchique]', 'Rappel avancement campagne EP [Supérieur·e hiérarchique]', 'campagne', 'P2W');
