...
WITH e(code, libelle, icone, couleur, ordre) AS (
    ...
    SELECT 'DEMANDE_EXTERNE_REJETEE', 'Demande de formation externe rejetée', 'fas fa-times', '#a40000', 60 UNION
    SELECT 'DEMANDE_EXTERNE_RESP', 'Validation du responsable de l''agent', 'fas fa-user-tie', '#edd400', 30 UNION
    SELECT 'DEMANDE_EXTERNE_TERMINEE', 'Demande de formation externe traitée', 'far fa-check-square', '#4e9a06', 50
)
SELECT et.id, e.code, e.libelle, e.icone, e.couleur, e.ordre
FROM e
JOIN unicaen_etat_categorie et ON et.CODE = 'DEMANDE_EXTERNE';
...
SELECT et.id, e.code, e.libelle, e.icone, e.couleur, e.ordre
FROM e
JOIN unicaen_etat_categorie et ON et.CODE = 'FORMATION_SESSION';
...
WITH e(code, libelle, icone, couleur, ordre) AS (
    ...
    SELECT 'FORMATION_INSCRIPTION_REFUSER', 'Demande refusée', 'fas fa-times', '#a40000', 110 UNION
    SELECT 'FORMATION_INSCRIPTION_RESPONSABLE', 'Demande validée par le responsable', 'fas fa-user-tie', '#edd400', 20

)
SELECT et.id, e.code, e.libelle, e.icone, e.couleur, e.ordre
FROM e
JOIN unicaen_etat_categorie et ON et.CODE = 'FORMATION_INSCRIPTION';
...
('FORMATION_DEMANDE_DRH', 'Validation d''un demande de formation externe par la DRH', false),('FORMATION_DEMANDE_REFUS', 'Refus d''une demande externe', false);
...
WITH d(code, libelle, description, valeurs_possibles, ordre) AS (
    SELECT 'NB_PLACE_PRINCIPALE', 'Nombre de place par défaut des la liste principale', null, 'Number', 100 UNION
    SELECT 'NB_PLACE_COMPLEMENTAIRE', 'Nombre de place par défaut des la liste complémentaire', null, 'Number', 110 UNION
    SELECT 'MAIL_DRH_FORMATION', 'Adresse électronique de la liste des gestionnaires de formation', null, 'String', 200 UNION
    SELECT 'MAIL_PREVENTION_FORMATION', 'Adresse électronique de la liste des gestionnaires de formation liée à la prévention', null, 'String', 210 UNION
    SELECT 'MAIL_PERSONNEL', 'Adresse électronique de la liste d''échange avec les personnels à propos des formations', null, 'String', 220 UNION
    SELECT 'URL_PPP', 'Lien vers la page interne associée au projet professionnel et personnel', null, 'String', 300 UNION
    SELECT 'AUTO_FERMETURE', 'Délai pour fermeture automatique des inscriptions (en jours)', null, 'Number', 400 UNION
    SELECT 'AUTO_CONVOCATION', 'Délai pour convocation automatique des inscrits (en jours)', null, 'Number', 410 UNION
    SELECT 'AUTO_RETOUR', 'Délai pour la demande de retour (en jours)', null, 'Number', 420 UNION
...
INSERT INTO unicaen_renderer_template (code, description, document_type, document_sujet, document_corps, document_css, namespace) VALUES ('FORMATION_CONVOCATION', null, 'pdf', 'Convocation à la session de formation VAR[SESSION#libelle]', e'<p> </p>
<p> </p>
<p> </p>
<p> </p>
...
<p> </p>
<p style="text-align: right;">La responsable du bureau conseil, carrière, compétences.<br /><br /></p>', null, 'Formation\Provider\Template');
...
<p style="line-height: 1.2em; color: #000000; font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 14px; font-style: normal; font-variant-ligatures: normal; font-variant-caps: normal; font-weight: 400; letter-spacing: normal; orphans: 2; text-align: start; text-indent: 0px; text-transform: none; white-space: normal; widows: 2; word-spacing: 0px; -webkit-text-stroke-width: 0px; text-decoration-thickness: initial; text-decoration-style: initial; text-decoration-color: initial;"> </p>
<p style="line-height: 1.2em; color: #000000; font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 14px; font-style: normal; font-variant-ligatures: normal; font-variant-caps: normal; font-weight: 400; letter-spacing: normal; orphans: 2; text-align: start; text-indent: 0px; text-transform: none; white-space: normal; widows: 2; word-spacing: 0px; -webkit-text-stroke-width: 0px; text-decoration-thickness: initial; text-decoration-style: initial; text-decoration-color: initial;"> </p>
<p style="line-height: 1.2em; color: #000000; font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 14px; font-style: normal; font-variant-ligatures: normal; font-variant-caps: normal; font-weight: 400; letter-spacing: normal; orphans: 2; text-align: start; text-indent: 0px; text-transform: none; white-space: normal; widows: 2; word-spacing: 0px; -webkit-text-stroke-width: 0px; text-decoration-thickness: initial; text-decoration-style: initial; text-decoration-color: initial;">Le bureau conseil, carrière, compétences.<br />drh.formation@unicaen.fr<br />VAR[Url#MesFormations]</p>
<p> </p>', null, 'Formation\Provider\Template');
INSERT INTO unicaen_renderer_template (code, description, document_type, document_sujet, document_corps, document_css, namespace) VALUES ('FORMATION_INSCRIPTION_PREVENTION', null, 'mail', 'Validation de l''inscription de VAR[AGENT#denomination] à une formation de prévention', e'<p>Bonjour,</p>
...
<p> </p>
<p>Bonne journée,<br />L\'application VAR[EMC2#appname]</p>', null, 'Formation\Provider\Template');
...
<p>Mes Formations</p>', null, 'Formation\Provider\Template');
...
<p><br /><br />Bonjour VAR[AGENT#denomination],<br /> <br /><br />Votre inscription à la session de formation formation VAR[SESSION#libelle] (formation VAR[SESSION#identification]) du VAR[SESSION#periode] est confirmée.<br /><br /><br />Vous allez prochainement recevoir par courrier électronique votre convocation et vous pourrez la télécharger via l\'application VAR[Url#MesFormations].<br /><br />Cette convocation vaut ordre de mission.<br /><br /><br /><br />Le bureau conseil, carrière, compétences.<br />drh.formation@unicaen.fr</p>', null, 'Formation\Provider\Template');
INSERT INTO unicaen_renderer_template (code, description, document_type, document_sujet, document_corps, document_css, namespace) VALUES ('FORMATION_DEMANDE_EXTERNE_TOTALEMENT_VALIDEE', '<p>Mail envoyé vers le CCC lorsque d''une demande extérieur est totalement validée</p>', 'mail', 'La demande stage externe de VAR[AGENT#denomination] est maintenant totalement validée', e'<p>Bonjour,</p>
...
<p>L\'application VAR[EMC2#appname]</p>', null, 'Formation\Provider\Template');
INSERT INTO unicaen_renderer_template (code, description, document_type, document_sujet, document_corps, document_css, namespace) VALUES ('FORMATION_DEMANDE_EXTERNE_VALIDATION_DRH', '<p>Courrier envoyé lors de la validation par la drh d''une demande externe (Agent et Responsable)</p>', 'mail', 'Validation de la demande de formation externe de VAR[AGENT#denomination] par le bureau gérant les formations', e'<p><strong>Université de Caen Normandie</strong><br />DRH - Bureau conseil, carrière, compétences<br />Esplanade de la Paix<br />14032 CAEN CEDEX 5</p>
<p>À Caen, le VAR[EMC2#date]</p>
<p> </p>
<p>Bonjour,</p>
...
<p>drh.formation@unicaen.fr</p>', null, 'Formation\Provider\Template');
...
<p>Le bureau conseil carrière compétences,</p>
<p>drh.formation@unicaen.fr</p>', null, 'Formation\Provider\Template');
INSERT INTO unicaen_renderer_template (code, description, document_type, document_sujet, document_corps, document_css, namespace) VALUES ('FORMATION_NOTIFICATION_NOUVELLES_SESSIONS', '<p>Mail envoyé périodiquement pour annoncer les nouvelles sessions</p>', 'mail', 'Nouvelles sessions de formation', e'<p><strong>Université de Caen Normandie</strong><br /><strong>DRH - Bureau conseil, carrière, compétences</strong><br />Esplanade de la Paix<br />14032 CAEN CEDEX 5</p>
<p>À Caen, le VAR[EMC2#date]</p>
<p> </p>
...
<p>Le bureau conseil carrière compétences,</p>
<p>drh.formation@unicaen.fr</p>', null, 'Formation\Provider\Template');
INSERT INTO unicaen_renderer_template (code, description, document_type, document_sujet, document_corps, document_css, namespace) VALUES ('FORMATION_INSCRIPTION_3_DRH_REFUS', '<p>Refus de la demande d''inscription par la DRH (DRH &gt; Agent)</p>', 'mail', 'Refus de la demande d''inscription à la formation VAR[FORMATION_INSTANCE#Libelle] du VAR[FORMATION_INSTANCE#Periode] par la direction des ressources humaines.', e'<p><strong>Université de Caen Normandie</strong><br /><strong>DRH - Bureau conseil, carrière, compétences</strong><br />Esplanade de la Paix<br />14032 CAEN CEDEX 5</p>
<p>À Caen, le VAR[EMC2#date]</p>
...
<p> </p>
<p>Le bureau conseil, carrière, compétences.<br />drh.formation@unicaen.fr</p>', null, 'Formation\Provider\Template');
INSERT INTO unicaen_renderer_template (code, description, document_type, document_sujet, document_corps, document_css, namespace) VALUES ('FORMATION_SESSION_LISTE_COMPLEMENTAIRE', '<p>Mail envoyé aux agents (individuellement) lors d''une inscription en liste complémentaire</p>', 'mail', 'Vous êtes inscrit sur la liste complémentaire de la session de formation VAR[SESSION#libelle]', e'<p>Université de Caen Normandie<br />DRH - Bureau conseil, carrière, compétences<br />Esplanade de la Paix<br />14032 CAEN 5                                                                                                                                     <br /><br />A Caen, le VAR[EMC2#date]</p>
...
<p>En cas d\'empêchement, merci de vous désinscrire via l\'application EMC2 : VAR[URL#App].<br /><br /> <br /><br />Le bureau conseil, carrière, compétences vous souhaite une session de formation enrichissante.<br /><br /> <br /><br />La responsable du bureau conseil, carrière, compétences.<br /><br />drh.formation@unicaen.fr</p>', null, 'Formation\Provider\Template');
...
<p>À Caen, le VAR[EMC2#date]</p>
<p> </p>
<p>Bonjour,<br /><br />Voici la liste des sessions de formations dont les inscriptions ont été automatiquement clôturées :<br />###A REMPLACER###<br /><br />Mes Formations</p>', null, 'Formation\Provider\Template');
...
<p><br /><br />La responsable du bureau conseil, carrière, compétences.<br />drh.formation@unicaen.fr</p>', 'table {border:1px solid black;}', 'Formation\Provider\Template');
