...
VALUES ('metier', 'Gestion des métiers', 'Metier\Provider\Privilege', 551);
...
INSERT INTO unicaen_privilege_categorie (code, libelle, namespace, ordre)
VALUES ('referenceMetier', 'Gestion des références métiers', 'Metier\Provider\Privilege', 555);
INSERT INTO unicaen_privilege_privilege(CATEGORIE_ID, CODE, LIBELLE, ORDRE)
WITH d(code, lib, ordre) AS (
...
INSERT INTO unicaen_privilege_categorie (code, libelle, namespace, ordre)
VALUES ('referentielMetier', 'Gestion des référentiels métiers', 'Metier\Provider\Privilege', 554);
INSERT INTO unicaen_privilege_privilege(CATEGORIE_ID, CODE, LIBELLE, ORDRE)
WITH d(code, lib, ordre) AS (
...
INSERT INTO unicaen_privilege_categorie (code, libelle, namespace, ordre)
VALUES ('domaine', 'Gestion des domaines', 'Metier\Provider\Privilege', 552);
INSERT INTO unicaen_privilege_privilege(CATEGORIE_ID, CODE, LIBELLE, ORDRE)
WITH d(code, lib, ordre) AS (
...
INSERT INTO unicaen_privilege_categorie (code, libelle, namespace, ordre)
VALUES ('familleProfessionnelle', 'Gestion des familles professionnelles ', 'Metier\Provider\Privilege', 553);
INSERT INTO unicaen_privilege_privilege(CATEGORIE_ID, CODE, LIBELLE, ORDRE)
WITH d(code, lib, ordre) AS (
